(define
	...
	(:action EXPLAIN_OBS_ADDRESS_MEDIA_POLICECHIEF_1
		...
		(and
			...
			(not ( NEEDED_ADDRESS_MEDIA ))
			 (not ( NOT_EXPLAINED_ADDRESS_MEDIA_POLICECHIEF_1 ))
	...
	(:action ADDRESS_MEDIA_MEDICCHIEF
		:parameters ()
		:precondition
		(and
			( NEEDED_ADDRESS_MEDIA )
	...
	(:action ATTEND_CASUALTIES_MEDICCHIEF_BYENG
		:parameters ()
		:precondition
		(and
			( DEPLOYED_AMBULANCES_BYENG )
	...
	(:action ISSUE_LOCAL_ALERT_MEDICCHIEF
		:parameters ()
		:precondition
		(and
			( MEDIA_CONTACTED_MEDICCHIEF )
	...
	(:action SET_UP_HELPLINE_MEDICCHIEF
		:parameters ()
		:precondition
		(and
			( MEDIA_CONTACTED_MEDICCHIEF )
	...
	(:action CONTACT_MEDIA_MEDICCHIEF
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_MARKETPLACE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_BANNER
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_JOSEPH
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_GUADAFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_PHXFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_SCOTTSFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_MESAFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_ADMINFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_SUBSTATION
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_COURTSTATION
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICCHIEF_APACHESTATION
		:parameters ()
		:precondition
		(and
		)
