(define
	...
	(:predicates
		...
		( PREPARED_EVACUATION_GUADAFIRE )
		( PREPARED_EVACUATION_LUKES )
		( PREPARED_EVACUATION_JOSEPH )
		( PREPARED_EVACUATION_BANNER )
		...
		( HAS_LADDERS_NUMBER_GUADAFIRE )
		( HAS_LADDERS_NUMBER_PHXFIRE )
		( HAS_LADDERS_NUMBER_SCOTTSFIRE )
		( HAS_LADDERS_NUMBER_MESAFIRE )
		( HAS_LADDERS_NUMBER_ADMINFIRE )
		( HAS_BIG_ENGINES_NUMBER_GUADAFIRE )
		( HAS_BIG_ENGINES_NUMBER_PHXFIRE )
		( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE )
		( HAS_BIG_ENGINES_NUMBER_MESAFIRE )
		( HAS_BIG_ENGINES_NUMBER_ADMINFIRE )
		( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE )
		( HAS_SMALL_ENGINES_NUMBER_PHXFIRE )
		...
		( EXPLAINED_CONTACT_MEDIA_FIRECHIEF_1 )
		( EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_1 )
		( EXPLAINED_DEPLOY_BULLDOZERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_2 )
		( EXPLAINED_DEPLOY_HELICOPTERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_3 )
		( EXPLAINED_DEPLOY_RESCUERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( EXPLAINED_EXTINGUISH_BIG_FIRE_FIRECHIEF_BYENG_1 )
		( EXPLAINED_SEARCH_CASUALTIES_FIRECHIEF_BYENG_1 )
		( EXPLAINED_ADDRESS_MEDIA_FIRECHIEF_1 )
		( NOT_EXPLAINED_CONTACT_MEDIA_FIRECHIEF_1 )
		( NOT_EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( NOT_EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_1 )
		( NOT_EXPLAINED_DEPLOY_BULLDOZERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( NOT_EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_2 )
		( NOT_EXPLAINED_DEPLOY_HELICOPTERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( NOT_EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_3 )
	...
	(:action EXPLAIN_OBS_CONTACT_MEDIA_FIRECHIEF_1
		:parameters ()
		:precondition
		(and
		)
		...
		(and
			...
			( MEDIA_CONTACTED_FIRECHIEF )
			 ( EXPLAINED_CONTACT_MEDIA_FIRECHIEF_1 )
			 (not ( NOT_EXPLAINED_CONTACT_MEDIA_FIRECHIEF_1 ))
		)
	)
	(:action EXPLAIN_OBS_DEPLOY_BIG_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_ADMINFIRE )
		...
		(and
			...
			(not ( HAS_BIG_ENGINES_NUMBER_ADMINFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_ALERT_FIRECHIEF_ADMINFIRE_1
		:parameters ()
		:precondition
		(and
			( EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 )
		...
		(and
			...
			( ALERTED_ADMINFIRE )
			 ( EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_1 )
			 (not ( NOT_EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_DEPLOY_BULLDOZERS_FIRECHIEF_ADMINFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_ADMINFIRE )
		...
		(and
			...
			(not ( HAS_BULLDOZERS_NUMBER_ADMINFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_BULLDOZERS_FIRECHIEF_ADMINFIRE_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_ALERT_FIRECHIEF_ADMINFIRE_2
		:parameters ()
		:precondition
		(and
			( EXPLAINED_DEPLOY_BULLDOZERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		...
		(and
			...
			( ALERTED_ADMINFIRE )
			 ( EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_2 )
			 (not ( NOT_EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_2 ))
		)
	)
	(:action ALERT_FIRECHIEF_ADMINFIRE
		:parameters ()
	...
	(:action EXPLAIN_OBS_DEPLOY_HELICOPTERS_FIRECHIEF_ADMINFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_ADMINFIRE )
		...
		(and
			...
			(not ( HAS_HELICOPTERS_NUMBER_ADMINFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_HELICOPTERS_FIRECHIEF_ADMINFIRE_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_ALERT_FIRECHIEF_ADMINFIRE_3
		:parameters ()
		:precondition
		(and
			( EXPLAINED_DEPLOY_HELICOPTERS_FIRECHIEF_ADMINFIRE_BYENG_1 )
		...
		(and
			...
			( ALERTED_ADMINFIRE )
			 ( EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_3 )
			 (not ( NOT_EXPLAINED_ALERT_FIRECHIEF_ADMINFIRE_3 ))
		)
	)
	(:action ALERT_FIRECHIEF_ADMINFIRE
		:parameters ()
	...
	(:action EXPLAIN_OBS_DEPLOY_RESCUERS_FIRECHIEF_ADMINFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( HAS_RESCUERS_NUMBER_ADMINFIRE )
		...
		(and
			...
			(not ( HAS_RESCUERS_NUMBER_ADMINFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_RESCUERS_FIRECHIEF_ADMINFIRE_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_EXTINGUISH_BIG_FIRE_FIRECHIEF_BYENG_1
		:parameters ()
		:precondition
		(and
			( DEPLOYED_BIG_ENGINES_BYENG )
		...
		(and
			...
			(not ( NOT_NEEDED_SEARCH_CASUALTIES_BYENG ))
			 (not ( NOT_EXPLAINED_EXTINGUISH_BIG_FIRE_FIRECHIEF_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_SEARCH_CASUALTIES_FIRECHIEF_BYENG_1
		:parameters ()
		:precondition
		(and
			( DEPLOYED_RESCUERS_BYENG )
		...
		(and
			...
			(not ( NOT_NEEDED_ADDRESS_MEDIA ))
			 (not ( NOT_EXPLAINED_SEARCH_CASUALTIES_FIRECHIEF_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_ADDRESS_MEDIA_FIRECHIEF_1
		:parameters ()
		:precondition
		(and
			( NEEDED_ADDRESS_MEDIA )
		...
		(and
			...
			(not ( NEEDED_ADDRESS_MEDIA ))
			 (not ( NOT_EXPLAINED_ADDRESS_MEDIA_FIRECHIEF_1 ))
	...
	(:action PREPARE_EVACUATION_POLICECHIEF_BANNER
		:parameters ()
		:precondition
		(and
			( ACTIVE_LOCAL_ALERT_POLICECHIEF )
	...
	(:action PREPARE_EVACUATION_POLICECHIEF_GUADAFIRE
		:parameters ()
		:precondition
		(and
			( ACTIVE_LOCAL_ALERT_POLICECHIEF )
	...
	(:action DEPLOY_AMBULANCES_POLICECHIEF_BANNER_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_AMBULANCES_NUMBER_BANNER )
		...
		(and
			...
			( DEPLOYED_AMBULANCES_BYENG )
			(not ( ALERTED_BANNER ))
			(not ( HAS_AMBULANCES_NUMBER_BANNER ))
		)
	)
	(:action DEPLOY_AMBULANCES_POLICECHIEF_BANNER_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_AMBULANCES_NUMBER_BANNER )
	...
	(:action DEPLOY_AMBULANCES_POLICECHIEF_BANNER_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_AMBULANCES_NUMBER_BANNER )
	...
	(:action DEPLOY_AMBULANCES_POLICECHIEF_BANNER_MILL
		:parameters ()
		:precondition
		(and
			( HAS_AMBULANCES_NUMBER_BANNER )
	...
	(:action DEPLOY_AMBULANCES_POLICECHIEF_BANNER_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_AMBULANCES_NUMBER_BANNER )
	...
	(:action DEPLOY_RESCUERS_FIRECHIEF_GUADAFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_RESCUERS_NUMBER_GUADAFIRE )
		...
		(and
			(increase (total-cost) 3)
			( DEPLOYED_RESCUERS_BYENG )
			(not ( ALERTED_GUADAFIRE ))
			(not ( HAS_RESCUERS_NUMBER_GUADAFIRE ))
		)
	)
	(:action DEPLOY_RESCUERS_FIRECHIEF_GUADAFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_RESCUERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_RESCUERS_FIRECHIEF_GUADAFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_RESCUERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_RESCUERS_FIRECHIEF_GUADAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_RESCUERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_RESCUERS_FIRECHIEF_GUADAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_RESCUERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_GUADAFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_GUADAFIRE )
		...
		(and
			...
			( DEPLOYED_HELICOPTERS_BYENG )
			(not ( ALERTED_GUADAFIRE ))
			(not ( HAS_HELICOPTERS_NUMBER_GUADAFIRE ))
		)
	)
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_GUADAFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_GUADAFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_GUADAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_GUADAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_SCOTTSFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_SCOTTSFIRE )
		...
		(and
			...
			( DEPLOYED_HELICOPTERS_BYENG )
			(not ( ALERTED_SCOTTSFIRE ))
			(not ( HAS_HELICOPTERS_NUMBER_SCOTTSFIRE ))
		)
	)
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_SCOTTSFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_SCOTTSFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_SCOTTSFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_SCOTTSFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_MESAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_MESAFIRE )
	...
	(:action DEPLOY_HELICOPTERS_FIRECHIEF_MESAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_HELICOPTERS_NUMBER_MESAFIRE )
	...
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_GUADAFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_GUADAFIRE )
		...
		(and
			...
			( DEPLOYED_BULLDOZERS_BYENG )
			(not ( ALERTED_GUADAFIRE ))
			(not ( HAS_BULLDOZERS_NUMBER_GUADAFIRE ))
		)
	)
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_GUADAFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_GUADAFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_GUADAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_GUADAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_MESAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_MESAFIRE )
	...
	(:action DEPLOY_BULLDOZERS_FIRECHIEF_MESAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_BULLDOZERS_NUMBER_MESAFIRE )
	...
	(:action DEPLOY_LADDERS_FIRECHIEF_GUADAFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_LADDERS_NUMBER_GUADAFIRE )
		...
		(and
			...
			( DEPLOYED_LADDERS_BYENG )
			(not ( ALERTED_GUADAFIRE ))
			(not ( HAS_LADDERS_NUMBER_GUADAFIRE ))
		)
	)
	(:action DEPLOY_LADDERS_FIRECHIEF_GUADAFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_LADDERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_LADDERS_FIRECHIEF_GUADAFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_LADDERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_LADDERS_FIRECHIEF_GUADAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_LADDERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_LADDERS_FIRECHIEF_GUADAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_LADDERS_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_GUADAFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_GUADAFIRE )
		...
		(and
			...
			(not ( ALERTED_GUADAFIRE ))
			(not ( NOT_NEEDED_BARRICADE_BYENG ))
			(not ( HAS_BIG_ENGINES_NUMBER_GUADAFIRE ))
		)
	)
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_GUADAFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_GUADAFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_GUADAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_GUADAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_PHXFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_PHXFIRE )
		...
		(and
			...
			(not ( ALERTED_PHXFIRE ))
			(not ( NOT_NEEDED_BARRICADE_BYENG ))
			(not ( HAS_BIG_ENGINES_NUMBER_PHXFIRE ))
		)
	)
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_PHXFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_PHXFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_PHXFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_PHXFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_SCOTTSFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE )
		...
		(and
			...
			(not ( ALERTED_SCOTTSFIRE ))
			(not ( NOT_NEEDED_BARRICADE_BYENG ))
			(not ( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE ))
		)
	)
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_SCOTTSFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_SCOTTSFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_SCOTTSFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_BIG_ENGINES_FIRECHIEF_SCOTTSFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_BIG_ENGINES_NUMBER_SCOTTSFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_GUADAFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE )
		...
		(and
			...
			(not ( ALERTED_GUADAFIRE ))
			(not ( NOT_NEEDED_BARRICADE_BYENG ))
			(not ( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE ))
		)
	)
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_GUADAFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_GUADAFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_GUADAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_GUADAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_GUADAFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_PHXFIRE_BYENG
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_PHXFIRE )
		...
		(and
			...
			(not ( ALERTED_PHXFIRE ))
			(not ( NOT_NEEDED_BARRICADE_BYENG ))
			(not ( HAS_SMALL_ENGINES_NUMBER_PHXFIRE ))
		)
	)
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_PHXFIRE_RURAL
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_PHXFIRE_MARKETPLACE
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_PHXFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_PHXFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_PHXFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_MESAFIRE_MILL
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_MESAFIRE )
	...
	(:action DEPLOY_SMALL_ENGINES_FIRECHIEF_MESAFIRE_LAKE
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_MESAFIRE )
	...
	(:action ALERT_TRANSPORTCHIEF_BANNER
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_TRANSPORTCHIEF_GUADAFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_MEDICHIEF_GUADAFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_FIRECHIEF_GUADAFIRE
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_POLICECHIEF_BANNER
		:parameters ()
		:precondition
		(and
		)
	...
	(:action ALERT_POLICECHIEF_GUADAFIRE
		:parameters ()
		:precondition
		(and
		)
